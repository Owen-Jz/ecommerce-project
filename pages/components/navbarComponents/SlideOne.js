...
export default function SlideOne({ dataIndex = 0, containerRef, setRef, onNext }) {
  ...
  return (
    <section
      ...
      aria-label="Luxury is a feeling before it is a possession"
    >
      <motion.img
        ...
        loading="eager"
      />
      <motion.div className="absolute inset-0 bg-neutral-900/35" style={{ opacity: fade }} />

      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 px-6 text-center">
        <h1 className="whitespace-pre-line text-white text-3xl sm:text-4xl md:text-[2.5rem] font-normal leading-tight">
          Luxury is a feeling before it is a possession
        </h1>
        <p className="text-white/90 text-sm sm:text-base md:text-lg">
          An invitation into a world defined by elegance, discretion, and rarity.
        </p>
